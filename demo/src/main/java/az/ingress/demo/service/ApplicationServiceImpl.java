...
public class ApplicationServiceImpl implements ApplicationService {
    ...
    public Application get(Long id){
        log.info("Application service get method is working.");
    ...
    public Application create(Application application){
        log.info("Application service create method is working.");
        Application a = Application.getInstance();
    ...
    public Application update(Application application){
        log.info("Application service update method is working.");
        Application a = Application.getInstance();
        if(a.getId()==application.getId()) {
            a.setId(application.getId());
            a.setAge(application.getAge());
    ...
    public void delete(Long id){
        log.info("Application service delete method is working.");
        Application a = Application.getInstance();
        if(a.getId()==id){
